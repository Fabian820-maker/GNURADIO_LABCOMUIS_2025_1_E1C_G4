...
class Practica1A(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Uso de GNUradio", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Uso de GNUradio")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Practica1A")
        ...
        self._frequency_win = qtgui.RangeWidget(self._frequency_range, self.set_frequency, "FrqHz", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._f_offset_win = qtgui.RangeWidget(self._f_offset_range, self.set_f_offset, "Offset", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._amplitud_win = qtgui.RangeWidget(self._amplitud_range, self.set_amplitud, "Amp", "counter_slider", float, QtCore.Qt.Horizontal)
        self.tab_source_grid_layout_0.addWidget(self._amplitud_win, 1, 0, 1, 1)
        for r in range(1, 2):
            self.tab_source_grid_layout_0.setRowStretch(r, 1)
        for c in range(0, 1):
            self.tab_source_grid_layout_0.setColumnStretch(c, 1)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, waveform, frequency, amplitud, offset, 0)
...
def main(top_block_cls=Practica1A, options=None):
